                    ...
                    <div className='flex justify-between items-start'>
                       ...
                       <div className='text-[#d0d2d6]'>
                            <div className='flex justify-between items-start border-b border-slate-700'>
                                  <div className='py-4 w-[25%] font-medium whitespace-nowrap'>3414351635411</div>
                                  <div className='py-4 w-[13%]'>$56</div>
                                  <div className='py-4 w-[18%]'>Peding</div>
                                  <div className='py-4 w-[18%]'>Peding</div>
                                  <div className='py-4 w-[18%]'>
                                       <Link>View</Link>
                                  </div>
                                  <div onClick={() => setShow(!show)} className='py-4 w-[8%] cursor-pointer'>
                                       <MdKeyboardArrowDown />
                                  </div>
                            </div> 
