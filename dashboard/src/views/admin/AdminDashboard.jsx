    ...
    <div className='px-2 md:px-7 py-5'>
        <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7'>
           ...
           <div className='w-full flex flex-wrap mt-7'>
               <div className='w-full md:w-7/12 lg:pr-3'>
                   <div className='w-full bg-[#283046] rounded-md p-4'>
                       <Chart options={state.options} series={state.series} type="bar" height={350} />
                   </div>
               </div>
               <div className='w-full md:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
                    <div className='w-full bg-[#283046] rounded-md p-4 text-[#d0d2d6]'>
                       <div className='flex justify-between items-center'>
                           ...
                           <Link to='/admin/dashboard/sellers' className='text-[#d0d2d6] text-sm font-semibold'>View All</Link>
                       </div>
                               ...
                               <li className='mb-3 ml-6'>
                                    ...
                                    <div className='p-3 bg-slate-800 rounded-lg border border-slate-600 shadow-sm'>
                                        <div className='flex justify-between items-center mb-2'>
                                                ...
                                                <time className='mb-1 text-sm font-normal sm:order-last'>4 day ago</time>
                                        </div>
           ...
           <div className='w-full bg-[#283046] rounded-md p-6'>
                <div className='flex justify-between items-center'>
                           ...
                           <tbody>
                                {
                                    ...
                                    <td scope='row' className='px-4 py-3 font-medium whitespace-nowrap'>#4545f51161611</td>
                                    <td className='px-4 py-3 font-medium whitespace-nowrap'>$6566</td>
                                    <td className='px-4 py-3 font-medium whitespace-nowrap'><span>Peding</span></td>
                                    <td className='px-4 py-3 font-medium whitespace-nowrap'><span>Peding</span></td>
                                    <td className='px-4 py-3 font-medium whitespace-nowrap'><Link>View</Link></td>                           
